...
/**
 * Builds ClickHouse DDL (CREATE TABLE) and INSERT SQL from a {@link ParsedSheet}.
 *
...
public class ClickHouseScriptBuilder {
    ...
    public String buildCreateScript(String tableName, ParsedSheet sheet) {
    ...
    public List<String> buildInsertColumns(ParsedSheet sheet) {
    ...
    public List<Object> buildRowValues(List<String> rawRow, ParsedSheet sheet,
